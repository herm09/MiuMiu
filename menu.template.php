...
<header class="banner">
    <nav class="navbar">
        ...
        <a href="http://localhost/test/connexion.php"><img src="Images_test/pp.png" alt="Photo de profil" class="rond"></a>
        <a href="http://localhost/test/deconnexion.php"><img src="Images_test/deco.png" alt="Déco" class="imglink"></a>
        <!-- <img src="Images_test/pp.png" href="http://localhost/site/index2.php" alt="Photo de profil" class="rond"> -->
        <!-- <li><a href="http://localhost/cours_grp2/index.php">Déconnexion</a></li> -->
    </nav>
</header>